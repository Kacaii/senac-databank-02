...
ALTER TABLE
  `Item_Venda`
ADD
  FOREIGN KEY(`id_promocao`) REFERENCES `Promocao`(`id`) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE
  `Venda`
ADD
  FOREIGN KEY(`id_funcionario`) REFERENCES `Funcionario`(`id`) ON UPDATE CASCADE ON DELETE CASCADE;
